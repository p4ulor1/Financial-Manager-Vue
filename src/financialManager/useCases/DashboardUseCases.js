export default class DashboardUseCases {
  ...
  getIncomesValuesByYear(budgetID, date) {
    return this.repository.getIncomesValuesByYear(budgetID, date);
  }
  ...
  getExpensesValuesByYear(budgetID, date) {
    return this.repository.getExpensesValuesByYear(budgetID, date);
  }
   ...
   * @param {String} budgetID
   * @param {String} date - YYYY-MM-DD
   * @returns {Promise<Array<CreditCardInvoices>>} - creditCardsInvoices
   */
  getCreditCardsInvoicesValueByYear(budgetID, date) {
    return this.repository.getCreditCardsInvoicesValueByYear(budgetID, date);
  }
  ...
  getContributionsValuesByYear(budgetID, date) {
    return this.repository.getContributionsValuesByYear(budgetID, date);
  }
}
